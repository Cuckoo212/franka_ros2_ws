...
DEFAULT_GRASP_ROOT = Path("/home/flexcycle/cv_models/cmcor/info_for_3Dpoint")
...
def analyze_and_save(args: argparse.Namespace, records: list[dict[str, Any]]) -> None:
    ...
    cable_id = normalize_cable_id(args.cable_id)
    ...
    grasp_plan_path = build_grasp_plan_path(cable_id, args.grasp_root)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("cable_id", help="Cable id such as 031.")
