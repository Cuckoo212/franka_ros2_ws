...
// Lift the executed trajectory 2 cm above the board. In the current setup,
// positive fr3_link0 Y points away from the board.
...
std::filesystem::path build_cable_plan_path(const std::string& cable_id) {
  ...
  // Calibration samples are generated by build_cable_point_cloud.py and store their
  // directly executable robot-frame trajectory in `skeleton_from_pc`.
  ...
  throw std::runtime_error("No cable trajectory found. Checked: " + standard_plan.string() +
