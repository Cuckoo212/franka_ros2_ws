...
class CartesianTargetPointBoardController : public controller_interface::ControllerInterface {
 public:
...
PLUGINLIB_EXPORT_CLASS(franka_example_controllers::CartesianTargetPointBoardController,
